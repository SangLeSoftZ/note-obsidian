...
<details><summary>Bài 1 — MethodChannel lấy mức pin từ native (xem D17_platform-channel-methodchannel.md)</summary>
...
<details><summary>Bài 2 — Gọi method không tồn tại, quan sát PlatformException (xem D17_platform-channel-methodchannel.md)</summary>
...
<details><summary>Bài 3 — restartable() cho Bloc tìm kiếm Task (xem D17_bloc-transformer-restartable-droppable.md)</summary>
...
<details><summary>Bài 4 — Đổi thành sequential(), quan sát kết quả sai lệch (xem D17_bloc-transformer-restartable-droppable.md)</summary>
...
<details><summary>Bài 5 — droppable() cho nút Đăng nhập (xem D17_bloc-transformer-restartable-droppable.md)</summary>
...
<details><summary>Bài 6 — @ValidPassword đầy đủ, áp dụng vào RegisterRequest (xem D17_custom-validator-annotation.md)</summary>
...
<details><summary>Bài 7 — @PasswordMatches ở cấp class (xem D17_custom-validator-annotation.md)</summary>
...
<details><summary>Bài 8 — Message lỗi linh động qua buildConstraintViolationWithTemplate (xem D17_custom-validator-annotation.md)</summary>
